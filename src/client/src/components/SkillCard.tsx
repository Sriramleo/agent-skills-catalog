      ...
      <div>
        ...
        <div className="mb-2.5">
          ...
          <div className="flex items-center justify-between gap-2 mt-0.5">
            ...
            {/* Quick Copy Slash Command */}
            <button
              onClick={handleCopySlash}
              className="text-[10px] font-mono px-2 py-0.5 rounded bg-slate-900 hover:bg-slate-800 text-cyan-400 border border-slate-800 hover:border-cyan-500/40 transition flex items-center gap-1"
              title="Click to copy slash command"
            >
              {copiedSlash ? <Check className="w-2.5 h-2.5 text-emerald-400" /> : null}
