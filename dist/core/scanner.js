...
export class SkillScanner {
    ...
    async scan(options = {}) {
        ...
        const skills = Array.from(skillsMap.values()).sort((a, b) => a.title.localeCompare(b.title));
