...
export class StaticExporter {
    static async exportCatalog(catalog, outputDir) {
    ...
    static copyDirRecursive(src, dest) {
    ...
    static generateMarkdownSummary(catalog) {
        const lines = [];
    ...
    static generateStandaloneHtml(catalog) {
        return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8"/>
